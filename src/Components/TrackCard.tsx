            ...
            <div className='flex h-auto bg-white w-[90vb] rounded-2xl shadow-lg'>
                ...
                <div className='flex flex-col w-full'>
                    <div className='flex justify-end items-center bg-sky-200'>
                        ...
                        {status=="alert"?<div className='bg-red-500 font-bold text-white my-3 px-5 py-1 mx-3 rounded-full'>{"."}</div>:<div className='bg-green-500 font-bold text-white my-3 px-5 py-1 mx-3 rounded-full'>{"."}</div>}
                    </div>
